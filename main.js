...
//this is to hid the legend box and other stuff but I realized I did not have enough time to fix it
...
//Self explanatory back button
        ...
        info.update = function (props) {
            this._div.innerHTML = '<h4>Country Online Spending</h4>' + (props ?
                ...
                : 'Hover over a country and the click to see other visualizations');
        };
